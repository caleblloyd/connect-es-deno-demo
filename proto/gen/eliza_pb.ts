...
import type {
  ...
  GenMessage,
  GenService,
} from "npm:@bufbuild/protobuf@^2.0.0/codegenv1"
import {
  fileDesc,
  messageDesc,
  serviceDesc,
} from "npm:@bufbuild/protobuf@^2.0.0/codegenv1"
import type { Message } from "npm:@bufbuild/protobuf@^2.0.0"
...
export const file_eliza: GenFile = /*@__PURE__*/
  fileDesc(
    "",
  )
 ...
 */
export const ConverseResponseSchema: GenMessage<
  ConverseResponse
> = /*@__PURE__*/
 ...
 */
export const IntroduceRequestSchema: GenMessage<
  IntroduceRequest
> = /*@__PURE__*/
 ...
 */
export const IntroduceResponseSchema: GenMessage<
  IntroduceResponse
> = /*@__PURE__*/
